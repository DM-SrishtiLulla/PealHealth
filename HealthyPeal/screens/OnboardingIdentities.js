  ...
  return (
    <React.Fragment>
      <TouchableOpacity
        ...
        {isChecked
          ? <Icon name='checkmark-circle-2-outline' style={{marginLeft: 10, marginTop: 10}} width={30} height={30} fill={"black"} />
          : <Icon name='radio-button-off-outline' style={{marginLeft: 10, marginTop: 10}} width={30} height={30} fill={"black"} />
          }
