...
const styles = StyleSheet.create({
    container: { flex: 1, justifyContent: 'center', padding: 10, paddingTop: 0, backgroundColor: COLORS.lightaccent },
    image: {
        height: 400,
    ...
    //             <Text style={{ color: COLORS.primary, fontSize: 24, fontWeight: "500" }}>Info</Text>
    //           </Button>
