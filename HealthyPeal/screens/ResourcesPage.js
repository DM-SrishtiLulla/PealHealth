...
export default function ResourcesPage({ navigation }) {
    return (
      <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.text}}>
        <View style={{flex: 1}}>
        <Text style={{marginTop: 40, fontSize: 40, alignSelf: "center", fontWeight: "bold", color: COLORS.darkprimary}}>Crisis Resources</Text>
          <ScrollView
          ...
          >
              <View style={{marginTop: 0, paddingHorizontal: 20}}>
                ...
                <Text style={{color: COLORS.darkprimary, fontSize: 24, fontWeight: "700"}}>
                  Options for Help
                </Text>
                <Text style={{color: COLORS.darkprimary, fontSize: 18, fontWeight: "bold", marginTop: 10}}>
  ...
  justifyContent: "space-between"}}>
      <View style={{width:width/2 - 30, height: width/2 - 30, marginVertical: 10, borderWidth:0.5, borderColor:COLORS.secondary}}>
        ...
        <View style={{flex: 1, alignItems:"flex-start", justifyContent: "space-evenly", paddingLeft: 10, backgroundColor:COLORS.darkprimary}}>
